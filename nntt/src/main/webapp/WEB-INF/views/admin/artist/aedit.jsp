...
<html>
<head>
    <title>Chỉnh sửa thong tin ca si</title>
</head>
<body>
    ...
    <div class="main-content-inner">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Chỉnh sửa thong tin ca si</li>
            </ul><!-- /.breadcrumb -->
        </div>
                ...
                <div class="col-xs-12">
                        ...
                        <form id="formSubmit">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="categoryCode" name="categoryCode">
                                        ...
                                        <c:if test="${not empty model.codetl}">
                                            <option value="">Chọn loại bài hát</option>
                                            <c:forEach var="item" items="${categories}">
                                                <option value="${item.code}" <c:if test="${item.code == model.codetl}">selected="selected"</c:if>>
                                                        ${item.name}
                                                </option>
                                            </c:forEach>
                                        </c:if>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="title" name="tenbh" value="${model.title}"/>
                                </div>
                            </div>
                            <br/>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="linkanh" name="thumbnail" value=""/>
                                </div>
                            </div>
                            <br/>
                            <br/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="codecs" name="shortDescription" value="${model.shortDescription}"/>
                                </div>
                            </div>
                            <br/>
                            <br/>
