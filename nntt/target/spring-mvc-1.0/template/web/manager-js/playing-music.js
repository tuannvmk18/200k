...
let songIndex = 0;
let songs = [
  "/template/web/music/24h-LyLy-pop.mp3",
  "/template/web/music/ChanAi-OrangeKhoi-pop.mp3",
  "/template/web/music/ChuyenRang-ThinhSuy-pop.mp3",
];
let thumbnails = [
  "/template/web/img/24h.jpg",
  "/template/web/img/chanai.jpg",
  "/template/web/img/chuyenrang.jpg"
];
let songArtists = ["LyLy", "Orange", "Thịnh Suy"];
let songTitles = ["24H", "Chân Ái", "Chuyện Rằng"];
let timer;
